package es.equipo3.ahorcado.test;
...
public class MainTest {
    ...
    public void jugarAhorcado() { // Metodo principal del juego
        ...
        while (vidas > 0) {
            ...
            char letra = in.nextLine().toLowerCase().charAt(0); // Lee la letra introducida por el usuario, se lee como un String y se convierte a char, para la           validacion se recoge el primer caracter de la cadena introducida.
